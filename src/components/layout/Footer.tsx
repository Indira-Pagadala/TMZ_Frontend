      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><button onClick={() => scrollNavTo('/category/technology')} className="text-sm text-muted hover:text-brand-primary transition-colors">Technology</button></li>
              <li><button onClick={() => scrollNavTo('/category/science')} className="text-sm text-muted hover:text-brand-primary transition-colors">Science</button></li>
              <li><button onClick={() => scrollNavTo('/category/culture')} className="text-sm text-muted hover:text-brand-primary transition-colors">Culture</button></li>
              <li><button onClick={() => scrollNavTo('/category/business')} className="text-sm text-muted hover:text-brand-primary transition-colors">Business</button></li>
            </ul>
          </div>
